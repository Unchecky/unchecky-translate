jquery_lang_js.prototype.lang.ja = {
	...
	'Copyright © 2018 Reason Company Software Inc.':
		'Copyright © 2018 Reason Company Software Inc. 日本語訳： <a href="mailto:contact@japan-secure.com">milksizegene</a>',
	...
	'Post your feedback on the <a href="http://unchecky.userecho.com/">UserEcho page</a>.':
		'あなたのご意見を<a href="http://unchecky.userecho.com/">ユーザーフォーラム（英語）</a>に投稿してください。',
	...
	'Unchecky can be uninstalled from the Windows Control Panel, like any other program. See instructions for <a href="https://support.microsoft.com/en-us/instantanswers/ce7ba88b-4e95-4354-b807-35732db36c4d/repair-or-remove-programs">Windows 10</a> or <a href="https://support.microsoft.com/en-us/kb/2601726">Windows 7</a>.':
		'一般的なプログラムと同様に、コントロールパネルからアンインストールできます。各Windowsにおける操作手順は以下をご覧ください：<a href="https://support.microsoft.com/en-us/instantanswers/ce7ba88b-4e95-4354-b807-35732db36c4d/repair-or-remove-programs">Windows 10</a>あるいは<a href="https://support.microsoft.com/en-us/kb/2601726">Windows 7</a>.',
	...
	'Yes, run the installer with the <code>-install</code> command line switch. For a list of supported command line switches, run <code>unchecky_setup.exe -?</code>.':
		'はい、コマンドラインスイッチ<code>-install</code> をつけてインストーラーを実行します。サポートされているコマンドラインスイッチの一覧は <code>unchecky_setup.exe -?</code>を実行してください。',
	...
	'Please don\'t use this contact form to report bugs or suggest features. Post your feedback on the <a href="http://unchecky.userecho.com/">UserEcho page</a> instead.':
		'バグの報告や機能改善等の提案に、このお問い合わせフォームを使用しないで下さい。左記に関するお問い合わせは<a href="http://unchecky.userecho.com/">ユーザーフォーラム</a>に投稿してください。',
